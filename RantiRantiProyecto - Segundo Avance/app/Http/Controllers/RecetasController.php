...
class RecetasController extends Controller
{
    ...
    {
        $caterece=CategoriaReceta::all();
        return view('CRUD.Recetasview.Insertar',compact('caterece'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $receta->idtiporeceta=$request->idtiporeceta;
        $receta->save();
    ...
    public function show($idreceta)
    {
        ...
        return view('CRUD.Recetasview.Editar',compact('receta','caterece'));
    }
    /**
